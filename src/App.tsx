                ...
                {(
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-2 rounded-xl font-bold border cursor-pointer transition-colors duration-150 ${
                        isActive
                          ? "bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 shadow-sm border-slate-200/30 dark:border-slate-800/60"
                          : "bg-transparent text-slate-500 dark:text-slate-400 border-transparent hover:text-slate-800 dark:hover:text-slate-100"
                      }`}
                    >
                      ...
                      {(["EMA", "WMA", "Hybrid"] as const).map((method) => {
                        ...
                        return (
                          <button
                            ...
                            className={`py-3 rounded-xl text-xs md:text-sm font-bold uppercase cursor-pointer border transition-colors duration-150 ${
                              isActive
                                ? "bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 shadow-sm border-slate-200/50 dark:border-slate-700/60"
